...
object DatabaseList  {
    ...
    init {
        ...
        val civilLawDatabase = Database("/Users/egfedo/IdeaProjects/CyberInna/db.json", prefix="Г-", dbID = "civilLaw")
...
//    println(civilLawDatabase.addEntries("/Users/egfedo/IdeaProjects/CyberInna/test.txt"))
        ...
        val constDatabase = Database("/Users/egfedo/IdeaProjects/CyberInna/constitutionDB.json", prefix="К-", dbID = "constLaw")
